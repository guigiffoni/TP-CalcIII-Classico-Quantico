...
\begin{itemize}
    ...
    \item \textbf{Sensibilidade Térmica:} Demonstrou-se que o erro cresce proporcionalmente ao cubo da temperatura ($P_{erro} \propto T^3$), indicando que reduções de apenas $25^{\circ}C$ podem ser suficientes para cruzar o limiar de operabilidade do sistema.
\end{itemize}
